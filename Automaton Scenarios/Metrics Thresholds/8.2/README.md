...
Этот сценарий обрабатывает изменяющиеся пороговые значения метрик, создавая и закрывая Сигналы. Уровни критичности Сигналов соответствуют уровням, установленным в правилах Порогов. Подтверждающие Сигналы не предусмотрены, т.к. если обновленная метрика не выходит за пределы предыдущего порогового значения, сценарий не активируется. В случае изменения Порога, старый Сигнал закрывается и открывается новый, с новым уровнем критичности.
